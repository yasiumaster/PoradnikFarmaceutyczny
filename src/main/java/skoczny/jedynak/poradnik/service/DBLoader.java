...
//===============  KATEGORIA CHOROBY ==============================
        ...
        KategoriaChoroby krazenia = addKategoriaChorobyToDB("Choroby ukladu kraøenia?");
        ...
        KategoriaChoroby metabolcizne = addKategoriaChorobyToDB("Zaburzenia wydzielania wewnetrznego, stanu odøywienia i przemiany metabolicznej");
        kategorie.add(metabolcizne);
        KategoriaChoroby zakazne = addKategoriaChorobyToDB("Choroby zakaüne");
...
//===============  CHOROBA  ==============================
        ...
        addChorobaToDB("Pierwotna øolciowa marskosc watroby", ursocam, randomCategory(), defaultUser, ChorobyOpisy.marskosc);
        ...
        addChorobaToDB("Zakaøenia bakteryjne", pentaglobin, randomCategory(), defaultUser, ChorobyOpisy.zakazenieBakteryjne);
